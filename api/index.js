// api/index.js - Backend completo para Vai Voando
...
export default async function handler(req, res) {
    ...
    // ============================================================
    if (path.startsWith('/api/destinos/') && req.method === 'DELETE') {
    ...
    // ============================================================
    // ROTA: /api/destinos/:id (PUT - ATUALIZAR)
    // ============================================================
    if (path.startsWith('/api/destinos/') && req.method === 'PUT') {
        const id = path.split('/')[3];
        try {
            const buffers = [];
            for await (const chunk of req) {
